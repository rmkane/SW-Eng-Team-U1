 ...
 * image files:
 * 
 * JFileChooser chooser = new JFileChooser(); CustomFileFilter filter = new
 * CustomFileFilter( new String{"gif", "jpg"}, "JPEG & GIF Images")
...
// Found here:
// http://code.google.com/p/dbfilebrowser/source/browse/trunk/src/ExampleFileFilter.java?spec=svn78&r=78
...
public class CustomFileFilter extends FileFilter {
	 ...
	 * CustomFileFilter("jpg", "JPEG Image Images");
	 * 
	 ...
	 * CustomFileFilter(String {"gif", "jpg"});
	 * 
...
CustomFileFilter filter = new ExampleFileFilter();

    ...
    public final void initUI() {
		...
		class aboutaction implements ActionListener {// Action For About
			public void actionPerformed(ActionEvent e) {
				...
				JTextArea aboutText = new JTextArea("This application was created by:" +
						"\n\nJennifer Hill\nRyan Kane\nDorothy Kirlew\nDonald Shaner\n" +
						"and Sean Weber");
        ...
        //JTextArea canvas = new JTextArea(); // **CANVAS** - just placeholder right now
        //canvas.setBorder(LineBorder.createGrayLineBorder());
        
        //scene canvas = new scene();
        
		GLCanvas c = new GLCanvas();
        c.addGLEventListener(new scene(c));
